...
func Setup() {
	...
	err = Db.AutoMigrate(&Author{}, &Article{}, &Category{}, &User{}, &Lottery{}, &LuckySpell{}, &LuckyTodo{}, &LuckySong{}, &LotteryContent{}, &PlayerLotteryLog{}, &StarLog{}, &Tarot{}, &Price{}, &Order{}, &Question{})
	if err != nil {
