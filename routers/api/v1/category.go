...
func GetCategory(c *gin.Context) {
	...
	if err != nil {
		appG.Response(http.StatusInternalServerError, e.ErrorGetCategoriesFail, nil)
		return
	}

	count, err := categoryService.Count()
	if err != nil {
		appG.Response(http.StatusInternalServerError, e.ErrorCountCategoryFail, nil)
		return
	}
...
func AddCategory(c *gin.Context) {
	...
	if err != nil {
		appG.Response(http.StatusInternalServerError, e.ErrorAddCategoryFail, nil)
		return
	}
...
func EditCategory(c *gin.Context) {
	...
	if err != nil {
		appG.Response(http.StatusInternalServerError, e.ErrorEditCategoryFail, nil)
		return
	}
...
func DeleteCategory(c *gin.Context) {
	...
	if err = categoryService.Delete(); err != nil {
		appG.Response(http.StatusInternalServerError, e.ErrorDeleteCategoryFail, nil)
		return
	}
