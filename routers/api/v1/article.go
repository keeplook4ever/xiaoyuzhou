...
import (
	...
	"xiaoyuzhou/pkg/util"
	article_service2 "xiaoyuzhou/service/article_service"
...
func AddArticle(c *gin.Context) {
	...
	articleService := article_service2.ArticleInput{
...
func DeleteArticle(c *gin.Context) {
	...
	articleService := article_service2.ArticleInput{ID: id}
	exists, err := articleService.ExistByID()
	if err != nil {
		appG.Response(http.StatusInternalServerError, e.ErrorCheckExistArticleFail, nil)
		return
...
func GenerateArticlePoster(c *gin.Context) {
	appG := app.Gin{C: c}
	article := &article_service2.ArticleInput{}
