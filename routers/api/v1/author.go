...
func EditAuthor(c *gin.Context) {
	...
	if err != nil {
		appG.Response(http.StatusInternalServerError, e.ErrorEditAuthorFail, nil)
		return
	}
...
func GetAuthors(c *gin.Context) {
	...
	if err != nil {
		appG.Response(http.StatusInternalServerError, e.ErrorGetAuthorFail, nil)
		return
	}

	count, err := authorService.Count()
	if err != nil {
		appG.Response(http.StatusInternalServerError, e.ErrorCountAuthorFail, nil)
		return
	}
